...
<Meta title="Politique de confidentialité des données personnelles"/>


<SectionContainer header>
    <h2 class="header-2">Politique de confidentialité des données personnelles</h2>

    <h3 class="header-3">Définitions</h3>
    ...
    <h3 class="header-3">1- Nature des données collectées</h3>
    ...
    <h3 class="header-3">2- Communication des données personnelles à des tiers</h3>
    ...
    <h3 class="header-3">
        3- Information préalable pour la communication des données personnelles à des tiers en cas de fusion /
        absorption
    </h3>
    ...
    <h3 class="header-3">4- Agrégation des données</h3>
    ...
    <p>
        ...
        Utilisateur individuel ne puisse plus être identifié ou mentionné) et les informations non personnelles à des
        fins d'analyse du secteur et du marché, de profilage démographique, à des fins promotionnelles et publicitaires
    ...
    <h3 class="header-3">5- Collecte des données d'identité</h3>
    ...
    <p>
        ...
        résultant de la livraison des produits et / ou des services, en vertu du Contrat de licence utilisateur final,
        de la Limite de garantie, le cas échéant, ou de toute autre condition applicable. Vous ne fournirez pas de
        fausses informations nominatives et ne créerez pas de compte pour une autre personne sans son autorisation. Vos
        coordonnées devront toujours être exactes et à jour.
    </p>

    <h3 class="header-3">6- Collecte des données d'identification</h3>
    ...
    <h3 class="header-3">7- Collecte des données du terminal</h3>

    <p><b>Collecte des données de profilage et des données techniques à des fins de fourniture du service</b></p>
    ...
    <p><b>Collecte des données techniques à des fins publicitaires, commerciales et statistiques</b></p>
    ...
    <p>
        ...
        (nom, prénom, adresse...) éventuellement attachée à une donnée technique. Les données collectées sont
        susceptibles d’être revendues à des tiers.
    </p>

    <h3 class="header-3">8- Cookies</h3>
    ...
    <p>
        ...
        des informations relatives à la navigation sur le service (les pages que vous avez consultées, la date et
        l'heure de la consultation...) que nous pourrons lire lors de vos visites ultérieures.
    </p>
    ...
    <p>
        ...
        désactiver les cookies en passant par les options de réglage. Toutefois, vous êtes informé que certains services
    ...
    <h3 class="header-3">9 - Conservation des données techniques</h3>
    ...
    <h3 class="header-3">10- Délai de conservation des données personnelles et d'anonymisation</h3>
    ...
    <p>
        ...
        décrites dans les présentes Politiques de confidentialité. Au-delà de cette durée, elles seront anonymisées et
    ...
    <p>
        ...
        atteinte. Conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux
    ...
    <h3 class="header-3">11- Suppression du compte</h3>
    ...
    <h3 class="header-3">12- Indications en cas de faille de sécurité décelée par l'Éditeur</h3>
    ...
    <p>
        En aucun cas les engagements définis au point ci-dessus relatifs à la notification en cas de faille de sécurité
        ne peuvent être assimilés à une quelconque reconnaissance de faute ou de responsabilité quant à la survenance de
        l'incident en question.
    </p>

    <h3 class="header-3">13- Transfert des données personnelles à l'étranger</h3>
    ...
    <h3 class="header-3">14- Modification de la politique de confidentialité</h3>

    <p><b>
        En cas de modification de la présente Politique de Confidentialité, engagement de ne pas baisser le niveau de
        confidentialité de manière substantielle sans l'information préalable des personnes concernées
    </b></p>
    ...
    <h3 class="header-3">15- Droit applicable et modalités de recours</h3>

    <p><b>Application du droit français (législation CNIL) et compétence des tribunaux</b></p>

    <p>
        La présente Politique de Confidentialité et votre utilisation du Site sont régies et interprétées conformément
        aux lois de France, et notamment à la Loi n° 78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et
        aux libertés. Le choix de la loi applicable ne porte pas atteinte à vos droits en tant que consommateur
        conformément à la loi applicable de votre lieu de résidence. Si vous êtes un consommateur, vous et nous
        acceptons de se soumettre à la compétence non- exclusive des juridictions françaises, ce qui signifie que vous
        pouvez engager une action relative à la présente Politique de Confidentialité en France ou dans le pays de l'UE
        dans lequel vous vivez. Si vous êtes un professionnel, toutes les actions à notre encontre doivent être engagées
        ...
        ces tentatives, toutes contestations à la validité, l'interprétation et / ou l'exécution de la Politique de
        Confidentialité devront être portées même en cas de pluralité des défendeurs ou d'appel en garantie, devant les
        tribunaux français.
    </p>

    <h3 class="header-3">16- Portabilité des données</h3>
